...
import Lesson7.Classwork.Refactoring.Tanks.*;
import Lesson7.Classwork.Refactoring.Tanks.Action;
...
//        int covered = 0;
        ...
        for (int i = 0; i < tank.getMovePath(); i++) {
            ...
            if (!(material instanceof Brick) && !material.destroyable()) {
                System.out.println("[illegal move] direction: " + dir
                        + " tankX: " + tank.getX() + ", tankY: " + tank.getY());
                return;
            }
